---
title: Yaratıcı
description: Hytale'ın yaratıcı moduna ilişkin bilgiler
---

# Yaratıcı Mod

Hytale'ın yaratıcı modu, oyuncuların dünyayı istedikleri gibi şekillendirebileceği bir sanal alandır.

## Dünya Düzenleme Araçları

Yaratıcı mod, oyuncuların dünyayı şekillendirmesine yardımcı olacak bir takım araçlara sahiptir. Geri alma özelliği bu araçlara dahildir.

Araçların video tanıtımında aşağıdaki bölümlere isim verilmediğini lütfen unutmayın.

---

### Lazer İşaretçi

Oyuncunun bakış açısından baktığı yere doğru ilerleyen bir ışın gösterir.

#### Ayarlar

-
- Lazer Rengi (Hex Renk Kodu): Aralık 2025, Açıklama bilgisi bulunmuyor.

### Şekillendirme Fırçası

Kullanıcının araziyi yükseltip alçaltarak şekilleri daha doğru bir şekilde şekillendirmesine ve birleştirmesine olanak tanır. Boyama Fırçası'nın sahip olduğu çoğu özelliği barındırır.

### Çizgi Fırçası

Aralık 2025, bilgi bulunmuyor

### Seçme Aracı

Kullanıcının, blok veya önceden hazırlanmış bir nesnenin seçimini konum, döndürme ve sıkma yoluyla dönüştürerek dünyanın bölgelerini seçmesine ve düzenlemesine olanak tanır.
